...
def get_sta_dict(job_name):
    ...
    if job_name == 'willapa_bc':  # Willapa Bay Center PCSGA Mooring
        ...
        sta_dict = {
            ...
            'NH-01': (-124.100, 44.652),  # 30 m
            'NH-03': (-124.130, 44.652),  # 48 m
            'NH-05': (-124.177, 44.652),  # 60 m
            'NH-10': (-124.295, 44.652),  # 81 m
            'NH-15': (-124.412, 44.652),  # 90 m
            'NH-20': (-124.528, 44.652),  # 140 m
            'NH-25': (-124.650, 44.652)  # 296 m
        }
