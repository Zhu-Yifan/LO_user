...
Testing:
run extract_box_chunks.py -gtx cas2k_v0_x2b  -job byrd -surf True -uv_to_rho True -test True

Production run:
python extract_box_chunks.py -gtx cas2k_v0_x2b  -ro 0 -lt hourly -0 2017.01.01 -1 2017.12.31 -job byrd -surf True -uv_to_rho True > byrd.log &
