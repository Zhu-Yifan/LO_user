...
Testing:
run extract_box -gtx cas2k_v0_x2b -job sequim0 -test True

same but with all flags:
run extract_box -gtx cas2k_v0_x2b -ro 0 -0 2017.07.04 -1 2017.07.06 -lt daily -job sequim0 -test True

this command replicates what post/surface0 does
run extract_box -gtx cas2k_v0_x2b -ro 0 -0 2017.07.04 -1 2017.07.08 -lt daily -job full -surf True -Nproc 1 > full_surf.log
or
python extract_box.py -gtx cas2k_v0_x2b -ro 0 -0 2017.07.04 -1 2017.07.08 -lt daily -job full -surf True -Nproc 1 > full_surf.log
